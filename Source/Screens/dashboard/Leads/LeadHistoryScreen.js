...
import NewPitchItemComponent2 from '../../../Components/NewPitchItemComponent1';
...
export default function PitchedLeadScreen({navigation}) {
        ...
        useEffect(() => {
            fetch('http://192.168.206.103:7000/user/get_saved_leads/67')
        ...
        <>
            ...
            renderItem={({item}) => (<NewPitchItemComponent2 item={item}/>)}
